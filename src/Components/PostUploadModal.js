...
class PostModal extends Component {
    ...
    render () {
        ...
        const { isPostUploadModalClosed, isPostUploadModalSwitch } = this.props;
        return (
            <Container isPostUploadModalClosed={isPostUploadModalClosed}>
                <Modal onSubmit={this.handleSubmit}>
                    ...
                    <ButtonBox>
                        ...
                        <Button type="button" onClick={() => isPostUploadModalSwitch()} value="취소"/>
                    </ButtonBox>
                </Modal>
            </Container>      
        );
